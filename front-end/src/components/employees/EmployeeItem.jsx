...
const EmployeeItem = () => {
  ...
  return (
    <div className="py-4 sm:py-6 theme-bg-primary min-h-screen transition-colors duration-300">
      {/* Title */}
      <h1 className="responsive-heading font-bold mb-4 text-right theme-text-primary">
        {t("workersPage.title")}
      </h1>

      {/* Mobile filter toggle */}
      <button
        className="lg:hidden mb-4 inline-flex items-center gap-2 px-3 py-2 rounded theme-border-primary border theme-bg-secondary theme-text-primary hover:theme-bg-tertiary transition-colors duration-200 touch-target"
      ...
      <div
        ...
        } lg:block responsive-card mb-6 transition-colors duration-300`}
      >
        <h2 className="font-semibold mb-3 text-right theme-text-primary text-sm sm:text-base">
          {t("workersPage.employeeList")}
        </h2>
        <div className="flex flex-col lg:flex-row lg:items-end gap-3">
          <div className="flex-1">
            <label className="block mb-1 text-xs sm:text-sm text-right theme-text-secondary">
              {t("workersPage.department")}
            </label>
            <DepartmentDropdown
              includeAllOption
              className="w-full p-2 theme-bg-secondary theme-text-primary theme-border-primary touch-input"
            />
          </div>
          <div className="flex-1">
            <label className="block mb-1 text-xs sm:text-sm text-right theme-text-secondary">
          ...
          <div className="flex-none">
            <button
              onClick={clearAll}
              className="w-full lg:w-auto theme-bg-tertiary hover:theme-bg-primary theme-text-primary font-semibold py-2 px-3 rounded transition-colors duration-200 touch-button"
            >
              {t("common.clear")}
            </button>
          </div>
          <div className="flex-none">
            <button
              onClick={exportToCsv}
              className="w-full lg:w-auto flex items-center justify-center theme-accent theme-accent-hover text-white font-bold py-2 px-4 rounded transition-all duration-200 hover:scale-105 touch-button"
            >
      ...
      <div
        className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 max-w-7xl mx-auto"
        dir="ltr"
      >
        {/* LEFT: EmployeeCard spans cols 1-2 */}
        <div dir="rtl" className="lg:col-span-2 lg:col-start-1">
          <div className="responsive-card h-full transition-colors duration-300">
            <EmployeeCard
        ...
        <div dir="rtl" className="lg:col-span-1 lg:col-start-3">
          <div className="min-w-[260px] responsive-card transition-colors duration-300">
            <EmployeeList
            ...
            <div className="theme-bg-secondary/80 backdrop-blur supports-[backdrop-filter]:theme-bg-secondary/70 rounded-xl theme-shadow-md theme-border-primary border p-3 transition-colors duration-300">
              <div className="flex justify-center">
                <button
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center text-base sm:text-lg font-bold px-6 sm:px-8 py-3 rounded-lg theme-accent theme-accent-hover text-white transition-all duration-200 hover:scale-105 touch-button"
                >
